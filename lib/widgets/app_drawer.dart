...
class AppDrawer extends StatelessWidget {
  ...
  Future<int> _obterQuantidadeDeListas() async {
    final db = await BancoLocal.bancoDeDados;
    final resultado = await db.rawQuery('SELECT COUNT(*) as total FROM listas');
        ...
        return Drawer(
          child: ListView(
            ...
            children: <Widget>[
              ...
              FutureBuilder<int>(
                future: _obterQuantidadeDeListas(),
                builder: (context, snapshot) {
                  final totalListas = snapshot.data ?? 0;
                  return _buildDrawerItem(
                    icon: Icons.list_alt,
                    text: 'Listas $totalListas/20',
                    onTap: () {
                      Navigator.pop(context); // Fecha o menu
                      Navigator.push(
                        // Abre a tela de Listas
                        context,
                        MaterialPageRoute(
              ...
              _buildDrawerItem(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    ...
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ReceivedListsScreen(),
                    ),
                  );
                },
              ),
